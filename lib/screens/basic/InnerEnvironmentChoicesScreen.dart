...
class _InnerEnvironmentChoicesScreenState extends State<InnerEnvironmentChoicesScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body: Container(
          color: const Color(0xffffcc33),          alignment: Alignment.center,
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: const Color(0xffffcc33),                  shape: BoxShape.rectangle,
